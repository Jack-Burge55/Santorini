...
level_one = pygame.image.load("Graphics\\level_one.png").convert_alpha()
level_two = pygame.image.load("Graphics\\level_two.png").convert_alpha()
level_three = pygame.image.load("Graphics\\level_three.png").convert_alpha()
level_four = pygame.image.load("Graphics\\level_four.png").convert_alpha()
p_builder = pygame.image.load("Graphics\\p_builder.png").convert_alpha()
b_builder = pygame.image.load("Graphics\\b_builder.png").convert_alpha()
selector = pygame.image.load("Graphics\\selector.png").convert_alpha()
